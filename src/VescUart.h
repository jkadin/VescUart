...
class VescUart
{
  ...
  uint16_t lenPayloadAsync;
    ...
    /**
      * @brief      Set the serial port for logging
      * @param      port  - Reference to Serial port (pointer) 
      */
    void setLogPort(Stream* port);
    ...
    /** Variabel to hold the reference to the Serial object to use for logging. 
		  * Uses the class Stream instead of HarwareSerial */
		Stream* logPort = NULL;
